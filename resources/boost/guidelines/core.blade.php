...
- **IDE metadata**: `php artisan blade-ui-kit-bs:ide` generates `.vscode/blade-ui-kit-bootstrap.code-snippets` (VS Code snippets — zero install), `.vscode/blade-ui-kit-bootstrap.html-data.json` (VS Code Custom Data for a forthcoming dedicated extension), and `.vscode/blade-ui-kit-bootstrap.ide.json` (PhpStorm / Laravel Idea alias→class mapping). Respects the configured prefix and any merge/replace customisations.
